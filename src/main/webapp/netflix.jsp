...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="cssUJ/netflix.css">
...
$(function (){
	...
	$(".this_button_write").click(function (){
		var idx = $(".this_button_write").index($(this));
		var jumsu = $("#jumsu").val();
    	var comment = $(".this_input_write").eq(idx).val();
    	var movieDramaId = $(".notice-board").attr('movie_drama_id');
    	var memberId = "<%=profileID%>";
    	$(".comment-all-box").scrollTop(0);
		$(".comment-all-box").empty();
		if(!comment) {
			alert("감상평을 먼저 작성해 주세요.");
			return false;
		}
    	$.ajax({
    		type: 'get',
    		url: 'CommentWriteServlet',
    		data: {"jumsu" : jumsu , "movie_drama_id" : movieDramaId , "memberId" : memberId , "comment" : comment},
    		datatype: "json",
...
<body>
    <div class="window">
            ...
            <div class="movie-detail">
                ...
                <div class="notice-board">
                    ...
                    <div class="cm-content-area">
                        ...
                        <div style="font-size: 22px; color: white; padding: 40px 0 20px 0; text-align: center;">점수를 선택해주세요.</div>
                        ...
                        <div class="cm_form_intro_box"> 
	                            <div class="area_input_box"> 
	                                <input id="user_comment1"type="text" class="this_input_write" placeholder="감상평을 등록해주세요."> 
	                            </div> 
            ...
            <div class="drama-detail">
                ...
                <div class="notice-board">
                    ...
                    <div class="cm-content-area">
                        ...
                        <div class="cm_form_intro_box"> 
                            <div class="area_input_box"> 
                                <input id="user_comment2" type="text" class="this_input_write" placeholder="감상평을 등록해주세요."> 
                            </div> 
        ...
        <div class="background-fill" style="background: #141414; height: 101px; width: 1780px;position: absolute;">
            ...
            <div class="header-list">
                ...
                <ul class="tabbed-primary-navigation">
                    ...
                    <li id="dib-button" class="navigation-tab">
                        <a class="current-active" href="index3.jsp?profile_id=<%=profileID %>">영화관 검색</a>
                    </li>
                </ul>
                <div class="menu">
                    <div class="tab">
                    ...
                    <div class="caret">
                        <role role="menu" tabindex="0" class="account-drop-down">
                            ...
                            <div class="account-container">
                                <ul class="account">
                                    <li class="account-information-top" onclick="location.href='jspBR/p05.account.jsp?profile_id=<%=profileID %>'">
